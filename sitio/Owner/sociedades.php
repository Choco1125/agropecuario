  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"> Agregar sociedad </h5>
        ...
        <div class="modal-body">
          <form id="add_sociedad">
            ...
            <div class="form-group">
              ...
              <input name="nombre" type="text" class="form-control" id="nombre" placeholder="Ingrese el nombre de la sociedad">
            </div>
            <div class="form-group">
              <label for="nit"> Nit de la sociedad </label>
              <input name="nit" type="text" class="form-control" id="nit" placeholder="Ingrese el nit de la sociedad">
            </div>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" onclick="add_sociedad();" class="btn btn-success"> Agregar Sociedad </button>
	      </div>
    </div>
  </div>
</div>
...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#agregar_sociedad">	Agregar Sociedad
</button>
  ...
  <tbody>
  	<?php 
        ...
        <td> <?php echo $row['nit'] ?> </td>
  			<td> <img class="logos" src="<?php echo $row['logo'] ?>" alt=""> </td>
  			<td> 
...
<script>
  ...
  function add_sociedad(){
    ...
    if(nombre == ""){
      swal('Error!','Debe ingresar un nombre para la sociedad','error');
      return;
    }
    if(nit == ""){
      swal('Error!','Debe ingresar un nit para la sociedad','error');
      return;
    }
    if (file == undefined) {
