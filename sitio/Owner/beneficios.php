  ...
  <br>
    ...
    <th scope="col"> Eliminar </th>
		...
		<tbody>
			<?php 
				include "../../php/conection.php";
				$query = "SELECT g.id,g.fecha,g.n_factura,r.nombre,c.nombre AS 'cultivo',g.valor,g.observacion FROM gastos_post AS g INNER JOIN rubros_post AS r INNER JOIN cultivo as c WHERE g.rubro_id = r.id AND c.id = g.cultivo_id  AND g.finca_id=".$_SESSION['finca'];
				$sql = mysqli_query($conection, $query);
				if ($sql) {
					while ($row = mysqli_fetch_array($sql)) {
						?>
