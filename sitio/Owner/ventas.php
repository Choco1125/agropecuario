...
<div class="container contenedor ">
  ...
  <table class="table" id="tabla">
    ...
    <tbody>
      ...
      include "../../php/conection.php";
      $query = "SELECT ventas.id, ventas.n_remision, ventas.fecha, lote.nombre AS nombre_lote, cliente.nombre AS nombre_empleado, producto.nombre AS nombre_producto, ventas.cantidad, ventas.valor FROM ventas INNER JOIN lote ON ventas.lote_id = ventas.lote_id INNER JOIN cliente ON ventas.cliente_id = cliente.id INNER JOIN producto ON ventas.producto_id = producto.id WHERE lote.id_finca = " . $id_finca;
      $sql = mysqli_query($conection, $query);
      if ($sql) {
