    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-7">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-11">
                    <h1>Presupuesto / Labores al día</h1>
                </div>
            </div>
            <br>
            <br>
            <form id="data" method="POST">
                ...
                <div id="body">
                    <div class="form-group">
                        <label for="">Jornales</label>
                        <input id="jornales" name="jornales"  onchange="calcular()" type="number" class="form-control" check="true" />
                    </div>
                    <div class="form-group">
                        <label for="">Valor Jornal</label>
                        <input id="valor_jornales" onchange="calcular()" name="valor_jornales" type="text" class="form-control" check="true" />
                    </div>
                    <div class="form-group">
...
<script>
	...
	$('#labor').select2();
    $('#valor_jornales').maskMoney({precision:0});
    $('#valor').maskMoney({precision:0});
