				...
				<form id="data_empleados" method="POST">
					...
					<div id="aux" style="display:none;">
						<div class="form-group">
							...
							<input onblur="calcularValor()" class="form-control" id="kilos" name="kilos" type="text">
						</div>
					</div>
	...
	<div class="row justify-content-center">
		<div class="col-12 col-md-7">
			...
			<div class="row align-items-center">
				...
				<div class="col-11">
					<h1>Registro / Labores al contrato</h1>
				</div>
			</div>
			<br>
			<br>
			<form id="data" method="POST">
				...
				<div class="form-group">
					...
					<select name="labor" id="labor" class="custom-select" onchange="selectLabor()">
				...
				<div id="recoleccion" style="display:none;">
					<div class="form-group">
						...
						<input id="valor_kilo" name="valor_kilo" type="text" class="form-control">
					</div>
				</div>
...
<script>
	...
	function calcularValor() {
		$('#valor').val($('#kilos').val().replace(/,/g, "") * $('#valor_kilo').val().replace(/,/g, "")).focus();
	}
	...
	function openModalAddEmpleado() {
		if (tipoLabor != null) {
			if (tipoLabor == 'recoleccion') {
				if (valor_kilo.value == '') {
					swal('Error!', 'Primero debe de ingresar el valor por kilo', 'error').then(() => {
						valor_kilo.focus();
					});
				} else {
