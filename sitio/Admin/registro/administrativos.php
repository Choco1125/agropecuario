...
<div class="container contenedor">
  ...
  <div class="row">
    ...
    <div class="col-10">
      <h3 class="text-center"> Registro / Gastos Administrativos </h3>
    </div>
  </div>
  <br>
  ...
  <table class="table" id="tabla">
    ...
    <tbody>
      <?php
      $query = "SELECT g.fecha,g.n_factura,r.nombre,g.valor,g.observacion FROM gastos_administrativos AS g INNER JOIN rubro_administrativo AS r WHERE g.rubro_id = r.id AND g.tipo = 1 AND g.finca_id=" . $_SESSION['finca'];
      $sql = mysqli_query($conection, $query);
      if ($sql) {
        while ($row = mysqli_fetch_array($sql)) {
      ?>
